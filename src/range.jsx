  ...
  render() {
    ...
    return (
      ...
      <div className="App border-gray-900 border-2 w-1/3 flex justify-stretch flex-col ">
          ...
          <input type='range' min="0" max="100" value={count} id='test' className=' ml-10 h-4 font-extrabold '  />
          <p className='text-2xl inline'>{count}</p><button onClick={this.submit} name='submit' className='bg-red-500 hover:bg-red-700 text-white font-bold mx-5 py-2 px-4 rounded-full  my-5 w-1/4'>submit</button>
          <div>
